...
export const Bio = {
    ...
    resume: "https://drive.google.com/file/d/1LmFxqQ-Akewt6xlXYep62ynsA548CdIn/view",
    ...
    FreeCodeCamp:"https://www.freecodecamp.org/Manaswinisasmal",
  };
  export const skills = [
      ...
      skills: [
        ...
        },
        {
        ...
        },
          {
           name: "AngularJS",
          image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQu869f7nu9GjpHmwifIPzA0R5RaEhPg2EwbQ&usqp=CAU",
        },
        {
          name: "HTML",
        ...
        
        {
          name: "WordPress",
          image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA-Bpt7JlCmaaJTXg8b6ahJ3Cf0vzM0AxDYw&s",
        },
        {
          name: "TailwindCSS",
          image:
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "ExpressJS",
          image: "https://img-c.udemycdn.com/course/240x135/1840024_44e0.jpg",
        },
      ],
    },
    {
  ...
  // For Experience & Cources
  
  export const experiences = [
    {
      id: 0,
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRteRm05fjM_kmTWiwAsrmQk1-oqLNq4eimMqPVOMD2Iw&s",
      cources: "Jr. Web Developer",
    ...
    },
    {
      ...
      cources: "Modern React with Redux",
      date: "Sept 2023",
      desc: "React enables the seamless creation of interactive and dynamic UIs for web applications. Its core philosophy revolves around the concept of reusable components, allowing developers to efficiently manage and update the UI state as data changes.",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-e9ee1c6b-9d26-44e7-8aab-fd6b27f0ff23.jpg",
    },
    {
      id: 2,
      image:"https://img-c.udemycdn.com/course/240x135/756150_c033_4.jpg",
      cources: "Angular The Complete Guide",
      date: "Dec 2022",
      desc: "Angular simplifies the process of creating scalable and maintainable code. This framework supports the development of single-page applications.",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-5678591c-32fa-4e3f-9644-745a5f7d668c.jpg",
    },
    {
      id: 3,
      image: "https://img-c.udemycdn.com/course/240x135/625204_436a_3.jpg",
      cources: "The Web Developer BootCamp",
      date: "Nov 2021",
      desc: " Become a Developer With ONE course - HTML, CSS, JavaScript, React, Node, MongoDB and More!",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-d9e4962d-0cea-45e0-8534-7eb7400a2c19.jpg",
    },
    {
      id: 4,
      image: "https://img-c.udemycdn.com/course/240x135/366280_5908_2.jpg",
      cources: "Java Database Connection: JDBC and My SQL",
      date: "JUN 2021",
      desc: "Learn how to connect to a MySQL database with Java JDBC",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-61b622a8-489c-44bd-8e70-e089133b2ebb.jpg",
    },
    {
      id: 5,
      image: "https://img-c.udemycdn.com/course/240x135/594360_bee2_2.jpg",
      cources: "HTML5 & CSS3 Fundamentals",
      date: "Mar 2020",
      desc: "Design Website With HTML5 & CSS3",
    },
    {
      id: 6,
      image: "https://img-c.udemycdn.com/course/240x135/22169_1283_9.jpg",
      cources: "Java Multithreding",
      date: "May 2018",
      desc: "Java Multithreading unlocks the power of parallel execution, allowing developers to create responsive and efficient applications. ",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-OPS74MTJ.jpg",
    },
    {
      id: 7,
      image: "https://img-c.udemycdn.com/course/240x135/354422_f256_4.jpg",
      cources: "Eclipse IDE for Beginners: Increase Your Java Productivity",
      date: "july 2021",
      desc: "This course is aimed at developers who want to quickly get up to speed with developing applications with Eclipse.",
      doc: "https://udemy-certificate.s3.amazonaws.com/image/UC-69c52e8b-2f70-47ec-b4bd-dfeed1adb17b.jpg",
    },
  ];
  ...
  export const education = [
    {
      ...
      date: "Nov 2020",
      grade: "7.48 CGPA",
      desc:"Throughout my academic journey, I have immersed myself in a diverse range of subjects, from programming languages and software engineering to electronics and communication. The structured curriculum not only equipped me with a solid foundation in theoretical concepts but also provided ample opportunities for hands-on projects and real-world applications.",
      degree: "Bachelor of Technology - BTech, Computer Science and Engineering",
    },
    {
      id: 1,
       image:"https://odishabytes.com/wp-content/uploads/2022/07/college-e1659108062632-150x150.jpg",
      school:"Mahamayee Mahila Mahavidyalaya, Berhampur",
      date:"May 2016",
      grade:"68.78%",
      desc:"Throughout my time in high school, I dedicated myself not only to academic excellence but also to exploring various fields to identify my true calling. The diverse curriculum exposed me to a range of subjects, and I discovered a profound interest in Science, Technology, geology.",
      degree:"Council Of Higher Secondary Education, Odisha",
    },
    {
      id:2,
      image:"https://lh3.googleusercontent.com/p/AF1QipOrqczjNnxE-4Qs0b0HuOTmQpSsWpAxF830-ssx=s680-w680-h510",
      school:"V.V.Giri Girls High School, Berhampur",
      date:"May 2013",
      grade:"75.29%",
      desc:" I'm delighted to take you on a brief journey through my school career—a period that has not only shaped my academic foundation but has also been instrumental in molding my character and fostering a love for learning.",
  ...
  export const projects =[
      ...
      {
          id:6,
          title:"Basic Online Payment App",
          date:"Oct 2023",
      ...
      },
      {
          ...
          category:"WebApp",
          github:"https://monisasmal.github.io/LittleBoxIndia/",
      },
      {
          id:11,
          title:"Basic Book App",
          date:"June 2022",
          desc:"Embark on a literary journey with our Basic Book Project – a digital haven for readers and authors alike. This project is thoughtfully crafted to provide a user-friendly platform for book enthusiasts to explore, discover, and engage with a diverse range of literary works.",
          image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtCyGq73Yl8yr0YzSuxuS8-fJUQVGXDgPJRw&usqp=CAU",
          tags:["HTML", "CSS", "JavaScript", "Github", "VS Code"],
          category:"WebApp",
          github:"https://monisasmal.github.io/book/",
      },
      {
          id:12,
      ...
      },
      {
          ...
          date:"Nov 2022",
          desc:"Stay informed and connected with our Basic News Project – an all-encompassing platform designed to deliver timely and relevant news updates. This project provides users with a streamlined interface to explore diverse news categories, stay updated on current events, and engage with quality journalism.",
  ...
  {
    id:23,
    title:"Infinite Scrolling Project",
    date:"OCT 2024",
  ...
  {
    id:27,
    title:"PUMA Clone Project",
    date:"Oct 2024",
    desc:"Immerse yourself in the timeless challenge of strategy and skill with our PUMA Clone Project – a classic rendition of the beloved game reimagined for digital platforms. ",
    image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZkDWo0R1kdz1m0oeefU4rjCh5_GVNyQmTjQ&s",
    tags:["HTML","CSS",  "Github", "VS Code"],
    category:"WebApp",
    github:"https://monisasmal.github.io/PUMA-HTML-CSS/",
  },
  {
    id:28,
    ...
    date:"Sept 2024",
    desc:"Immerse yourself in the timeless challenge of strategy and skill with our PUMA Clone Project – a classic rendition of the beloved game reimagined for digital platforms. ",
    image:"https://i0.wp.com/pureinfotech.com/wp-content/uploads/2023/05/windows-11-install-youtube-app-hero.webp?fit=1673%2C1064&quality=78&strip=all&ssl=1",
    tags:["HTML","CSS",  "Github", "VS Code"],
    category:"WebApp",
